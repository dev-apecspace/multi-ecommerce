          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-xs text-muted-foreground">
                Tôi đồng ý với{' '}
                <Link href="/api/legal-documents/view/terms-of-service" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Điều khoản dịch vụ
                </Link>{' '}
                và{' '}
                <Link href="/api/legal-documents/view/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Chính sách bảo mật
                </Link>
              </span>
            </label>
