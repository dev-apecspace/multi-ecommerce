...
export default function CategoryPage({ params, searchParams }: CategoryPageProps) {
  ...
  return (
    <main className="min-h-screen bg-surface dark:bg-slate-950">
      <CategoryHeader slug={resolvedParams.slug} />
      ...
      <div className="container-viewport py-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-3">
            <ProductGrid category={resolvedParams.slug} subcategory={subcategory} filters={filters} sortBy={sortBy} onSortChange={setSortBy} />
          </div>
        </div>
      </div>
    </main>
