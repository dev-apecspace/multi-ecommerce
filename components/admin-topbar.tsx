  ...
  return (
    <div className="h-16 bg-white dark:bg-slate-950 border-b border-border flex items-center justify-between px-4 md:px-6 sticky top-0 z-40">
      <div className="flex items-center gap-2 md:gap-3 min-w-0">
        <Link href="/admin" className="text-sm md:text-xl font-bold text-orange-600 dark:text-orange-500 truncate">
          Sàn TMĐT APECSPACE
        </Link>
        <div className="hidden md:block text-sm text-muted-foreground">| Admin Panel</div>
      </div>
