...
const sellerLinks = [
  ...
  { href: "/seller/transactions", label: "Giao dịch & Doanh thu", icon: CreditCard, restricted: true },
  { href: "/seller/monthly-fees", label: "Phí hợp tác hàng tháng", icon: Wallet, restricted: true },
