...
export function SellerTopBar() {
  ...
  return (
    <div className="hidden h-16 items-center justify-between border-b border-border bg-white px-4 dark:bg-slate-950 md:sticky md:top-0 md:z-40 md:flex md:px-6">
