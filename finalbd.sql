...
CREATE INDEX IF NOT EXISTS idx_productreview_productId ON "ProductReview"("productId");
CREATE INDEX IF NOT EXISTS idx_productreview_userId ON "ProductReview"("userId");
CREATE INDEX IF NOT EXISTS idx_productreview_orderId ON "ProductReview"("orderId");
CREATE INDEX IF NOT EXISTS idx_productreview_rating ON "ProductReview"("rating");
